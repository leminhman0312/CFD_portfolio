module animation
  ...
  implicit none
  private
  public :: make_animation_implicit_adi_source, makeMP4
...
contains
  ...
  subroutine make_animation_implicit_adi_source(u0, t_end, deltax, deltay, alpha, dt, r_source, t_source)
    ...
    write(*,'(/,A)') 'ANIMATION (implicit ADI) source case'
    ...
    call execute_command_line('rm -f animation/png/frame_*.png animation/dat/frame_*.dat')
